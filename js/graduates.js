$(document).ready(function(){
    ...
    var db;
    var output = "<div class='col-md-4 portfolio-item'><img class='img-responsive' src='%%IMAGE%%'></a><h3>%%NAME%%</h3><p>%%CONTENT%%</p></div>";
    ...
    function queryDb(tx){
      tx.executeSql('SELECT * FROM graduates', [], querySuccess, errorCB);
    }
